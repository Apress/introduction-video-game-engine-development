...
namespace net.middlemind.DungeonTrap.ChapterE4_DemoScreen
{
    ...
    /// 09/19/2020
    /// </summary>
    public class MdtCharInterBanshee : MdtCharInter
    {
        /// <summary>
        /// MdtEnemyBanshee constructor that allows you to specify the sprite animation frames for this character, for all directions.
        /// </summary>
        ...
        public MdtCharInterBanshee(MmgSprite Subj, int FrameFrontS, int FrameFrontE, int FrameBackS, int FrameBackE, int FrameLeftS, int FrameLeftE, int FrameRightS, int FrameRightE, ScreenGame Screen)
            : base(Subj, FrameFrontS, FrameFrontE, FrameBackS, FrameBackE, FrameLeftS, FrameLeftE, FrameRightS, FrameRightE, Screen, MdtObjType.ENEMY, MdtObjSubType.ENEMY_BANSHEE)
        {
